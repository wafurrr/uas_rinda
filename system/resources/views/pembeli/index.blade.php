	...
	<div class="home">
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url({{url('public/pembeli')}}/images/1.jpg)"></div>
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url({{url('public/pembeli')}}/images/2.jpg)"></div>
					<div class="home_slider_content">
						<div class="container">
							<div class="row">
								<div class="col text-center">
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url({{url('public/pembeli')}}/images/3.jpg)"></div>
					<div class="home_slider_content">
						<div class="container">
							<div class="row">
								<div class="col text-center">
	...
	<div class="courses">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">Produk DONATS</h2>
			...
			<div class="row courses_row">
				...
				<div class="col-lg-4 course_col"><br><br>
					<div class="course">
						<div class="course_image"><img src="{{url('app/produk', $produk->gambar)}}" style="width: 300px; height: 300px; border-radius: 10px;"></div>
